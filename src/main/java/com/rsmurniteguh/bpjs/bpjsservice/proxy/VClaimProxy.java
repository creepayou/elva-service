...
public interface VClaimProxy {
        ...
        public VClaimResponse<List<VClaimMappingDto>> getDokterDPJP(
                        ...
                        @PathVariable("spesialis") String spesialis, @RequestHeader(Constant.MT_ENTITY_CODE) String entityCode);

        @GetMapping("/referensi/propinsi")
        public VClaimResponse<List<VClaimMappingDto>> getPropinsi(@RequestHeader(Constant.MT_ENTITY_CODE) String entityCode);
        ...
        public VClaimResponse2<BpjsRujukanListDto> getRujukanPCareListByNoKartu(
                        @PathVariable("noKartu") String noKartu, @RequestHeader(Constant.MT_ENTITY_CODE) String entityCode);
        ...
        public VClaimResponse<List<BpjsKlaimDto>> getDataKlaim(
                        ...
                        @PathVariable("jnsPelayanan") String jnsPelayanan,
                        @PathVariable("status") String status, @RequestHeader(Constant.MT_ENTITY_CODE) String entityCode);
