...
public class LZStringUtil {
	...
	private static char[] keyStrBase64 = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/="
			.toCharArray();
	private static char[] keyStrUriSafe = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+-$"
			.toCharArray();
	...
	public static String decompressFromBase64(final String inputStr) {
		...
		if (inputStr.equals(""))
			return null;
		return LZStringUtil._decompress(inputStr.length(), 32, new DecompressFunctionWrapper() {
			@Override
	...
	public static String decompressFromUTF16(final String compressedStr) {
		...
		if (compressedStr.isEmpty())
			return null;
		return LZStringUtil._decompress(compressedStr.length(), 16384, new DecompressFunctionWrapper() {
			@Override
			public char doFunc(int index) {
	...
	public static String decompressFromEncodedURIComponent(String inputStr) {
		...
		return LZStringUtil._decompress(urlEncodedInputStr.length(), 32, new DecompressFunctionWrapper() {
			@Override
			public char doFunc(int index) {
