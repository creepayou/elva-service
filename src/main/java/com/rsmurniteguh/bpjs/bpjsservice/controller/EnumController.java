...
public class EnumController {
    ...
    public ResponseSts<List<VClaimMappingDto>> getJenisPelayanan(@RequestHeader(Constant.MT_ENTITY_CODE) String entityCode) {
        try {
    ...
    public ResponseSts<List<VClaimMappingDto>> getStatusKlaim(@RequestHeader(Constant.MT_ENTITY_CODE) String entityCode) {
        try {
            List<VClaimMappingDto> vclaimMappingDtoList = new ArrayList<>();
    ...
    public ResponseSts<List<VClaimMappingDto>> getStatusPulang(@RequestHeader(Constant.MT_ENTITY_CODE) String entityCode) {
        try {
            List<VClaimMappingDto> vclaimMappingDtoList = new ArrayList<>();
