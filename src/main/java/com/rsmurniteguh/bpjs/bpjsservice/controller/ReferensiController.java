...
public class ReferensiController extends BaseController {
	...
	public ReferensiController(VClaimProxy vClaimProxy,
			BpjsConsumerController bpjsConsumerController,
	...
	public ResponseSts<List<VClaimMappingDto>> getDokterDPJP(
			@RequestParam("jenisPelayanan") JenisPelayanan jenisPelayanan,
